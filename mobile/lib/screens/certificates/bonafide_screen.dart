...
import 'package:mobile/utils/gujarati_utils.dart'; // Keep if needed for other things, but generation is now backend
...
class BonafideCertificateScreen extends StatefulWidget {
  ...
  const BonafideCertificateScreen({super.key, required this.student});

  @override
  State<BonafideCertificateScreen> createState() => _BonafideCertificateScreenState();
}
